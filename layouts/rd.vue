...
// علامت‌گذاری تب های فعال بر اساس route.path
const activeTab = computed(() => {
  if (route.path === '/RD/chart') return 'rd-chart'
  if (route.path === '/RD') return 'rd'
  if (route.path === '/RD/FollowUp') return 'follow-up'
  if (route.path === '/RD/Management') return 'management'
})
...
const navigationTabs = [
  ...
  {
    id: 'rd-chart',
    label: 'چارت سازمانی بخش R&D',
    icon: 'lucide:network',
    path: '/RD/chart'
  },
  {
    id: 'follow-up',
    label: 'پیگیری پیشنهادات',
    icon: 'lucide:network',
    path: '/RD/FollowUp'
  },
  {
    id: 'management',
    label: 'مدیریت پیشنهادات',
    icon: 'lucide:network',
    path: '/RD/Management'
  }
...
<template>
  ...
  <div class="w-full min-h-screen bg-white dark:bg-slate-950 flex flex-col">
