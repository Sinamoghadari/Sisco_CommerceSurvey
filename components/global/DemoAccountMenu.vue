...
<template>
  <div class="group inline-flex items-center justify-center text-right">
    ...
    >
      ...
      >
        <MenuItems
          class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 absolute mt-2 w-60 rounded-md border bg-white text-start shadow-lg focus:outline-none ltr:origin-bottom-right rtl:origin-bottom-left"
